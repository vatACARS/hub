        ...
        <div className="px-12 py-6 h-full text-slate-300">
          ...
          <section className="w-full px-12 pt-12">
            ...
            {state == 1 && (
              <div className="flex flex-col space-y-6 mt-4 text-slate-500 text-sm">
                ...
                <span id="subjectTo">This software is subject to the following policies and terms, including transfer of your data to countries that may have different levels of privacy protection than your own:</span>
                <div className="flex flex-col">
                <p id="privacy">Terms and Conditions, available at <a href="https://vatacars.com/terms" target="_blank" className="text-blue-500">www.vatacars.com/terms</a></p>
                  <p id="privacy">and Privacy Policy, available at <a href="https://vatacars.com/privacy" target="_blank" className="text-blue-500">www.vatacars.com/privacy</a></p>
                </div>
              </div>
            )}
          </section>
          <div className="absolute left-0 bottom-24 w-full px-24">
            <div className="w-full flex flex-row justify-end mt-12">
              <a onClick={() => state < 2 && progress()} className="rounded-full shadow-lg h-10 items-center px-6 py-2 uppercase font-bold cursor-pointer bg-slate-200 text-slate-900 hover:bg-blue-500 transition-all duration-200">{state < 2 ? "Continue" : (
                <PuffLoader size={24} />
              )}</a>
            </div>
          </div>
